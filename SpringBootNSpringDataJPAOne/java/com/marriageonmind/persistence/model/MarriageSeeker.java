...
public abstract class MarriageSeeker implements Serializable{
	...
	@OneToMany(mappedBy="marriageSeeker")
	private Collection<Occupation> occupation;
	...
	public Collection<Occupation> getOccupation() {
		return occupation;
	}

	public void setOccupation(Collection<Occupation> occupation) {
